...
#extended_algorithm_comparison_start
"""
...
"""
###extended algorithm comparison end
...
for count in range(5,20):      
        ...
        dtA.append(cross_val_score(rfc, X, y, cv=count, scoring = "accuracy").mean() )
        dtF.append(cross_val_score(rfc, X, y, cv=count, scoring = "f1").mean() )
        #bt.append(cross_val_score(btc, X, y, cv=count, scoring = "accuracy").mean() )
...
fig, axs = plt.subplots(2)
fig.suptitle('Random Forest performance, compared to baseline')
fig.set_size_inches(10, 7)
axs[0].plot(yx, dtA, label = "Random Forest Accuracy Score")
axs[1].plot(yx, dtF, label = "Random Forest F1 Score")
axs[0].plot(yx, am, label = "Baseline (Heuristic) Accuracy Score")
axs[1].plot(yx, fm, label = "Baseline (Heuristic) F1 Score")
axs[0].set_ylabel('Accuracy Score')
axs[1].set_ylabel('F1 Score')
...
for count in range(5,20):      
        ...
        dtA.append(cross_val_score(btc, X, y, cv=count, scoring = "accuracy").mean() )
        dtF.append(cross_val_score(btc, X, y, cv=count, scoring = "f1").mean() )
        #bt.append(cross_val_score(btc, X, y, cv=count, scoring = "accuracy").mean() )
...
fig, axs = plt.subplots(2)
fig.suptitle('Bagging performance, compared to baseline')
fig.set_size_inches(10, 7)
axs[0].plot(yx, dtA, label = "Bagging Accuracy Score")
axs[1].plot(yx, dtF, label = "Bagging F1 Score")
axs[0].plot(yx, am, label = "Baseline (Heuristic) Accuracy Score")
axs[1].plot(yx, fm, label = "Baseline (Heuristic) F1 Score")
axs[0].set_ylabel('Accuracy Score')
axs[1].set_ylabel('F1 Score')
