...
gbc = gbc.fit(X,y)
"""
mlpc1 = MLPClassifier(max_iter=100000,activation="relu", solver="sgd",learning_rate_init=0.01,validation_fraction=0.125, early_stopping=True, n_iter_no_change=300)
mlpc = MLPClassifier(max_iter=100000,activation="relu", solver="sgd",learning_rate_init=0.01,validation_fraction=0.125,n_iter_no_change=10000)
mlpc1 = mlpc1.fit(X,y)
...
while epoch < N_EPOCHS:
    ...
    while True:
        ...
        mlpc.partial_fit(X_train, y_train, classes=N_CLASSES)
    ...
    # SCORE TRAIN
    scores_train.append(mlpc.score(X_train, y_train))
...
#plt.plot(mlpc1.validation_scores_)
...
#plt.plot(scores_train, label="Training Accuracy Scores")
#plt.plot(scores_test, label="Training Testing Scores")

#plt.suptitle('Comparative performance of machine learning algorithms based on Decision Trees, with the manual algorithm as baseline')
...
#fig.suptitle('Neural Network Learning Progress')
#fig.set_size_inches(10, 7)


plt.figure(figsize=(10,7))
#plt.plot(mlpc1.loss_curve_, label = "Training Loss Curve")
#plt.plot(mlpc1.validation_scores_, label = "Test Accuracy Curve")
plt.ylabel('Score')
plt.xlabel('Epochs')

plt.plot(scores_train, label = "Training Accuracy Curve")
plt.plot(scores_test, label = "Test Accuracy Curve")
